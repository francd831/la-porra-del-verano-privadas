  	...
  	extend: {
  		...
  		keyframes: {
  			...
  			'pulse-glow': {
  				...
  				'50%': { boxShadow: '0 0 35px hsl(239 84% 67% / 0.5)' }
  			}
  		},
  		animation: {
  		...
  		boxShadow: {
  			...
  			'neon': '0 0 20px hsl(239 84% 67% / 0.3), 0 0 40px hsl(239 84% 67% / 0.1)',
  			'neon-accent': '0 0 20px hsl(152 100% 50% / 0.3), 0 0 40px hsl(152 100% 50% / 0.1)',
  			'2xs': 'var(--shadow-2xs)',
  			xs: 'var(--shadow-xs)',
  			sm: 'var(--shadow-sm)',
  			md: 'var(--shadow-md)',
