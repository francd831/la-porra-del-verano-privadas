export type ThirdPlaceOpponentSlot = "A" | "B" | "D" | "E" | "G" | "I" | "K" | "L";

export type ThirdPlaceAllocation = Record<ThirdPlaceOpponentSlot, string>;
...
export function getThirdPlaceAllocation(qualifiedThirdGroups: string[]): ThirdPlaceAllocation | null {
  const key = [...qualifiedThirdGroups].sort().join("");
  return THIRD_PLACE_ALLOCATIONS[key] || null;
}
